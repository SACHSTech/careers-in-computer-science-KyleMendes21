...
- [CS 135](http://ugradcalendar.uwaterloo.ca/courses/CS/135) - __Designing Functional Programs__: An introduction to the fundamentals of computer science through the application of programming patterns in the functional style of programming. 
- [Math 135](http://ugradcalendar.uwaterloo.ca/courses/MATH/135) - __Algebra__: An introduction to mathematics and proof techniques using a study of the basic algebraic systems of mathematics like integers, the complex numbers and polynomials.
- [Math 137](http://ugradcalendar.uwaterloo.ca/courses/MATH/137) - __Calculus 1__: Topics such as: absolute values and inequalities, sequences and their limits and an introduction to series like limits of functions will be covered. 
- One communication skills course
- One Elective
 
##### *January to April*
- [CS 136](http://ugradcalendar.uwaterloo.ca/courses/CS/136) - __Algorithm Design and Data Abstraction__: This course builds on the skills and patterns learned in CS 135 while transitioning to use an imperative language. And it talks about the design and analysis of algorithms, the management of information, and the programming mechanisms.
- [Math 136](http://ugradcalendar.uwaterloo.ca/courses/MATH/136) - __Linear Algebra 1__: You will cover systems of linear equations, matrix algebra, elementary matrices, and computational issues.  
- [Math 138](http://ugradcalendar.uwaterloo.ca/courses/MATH/138) - __Calculus 2__: You will cover Introduction to the Riemann integral and approximations. Antiderivatives and the fundamental theorem of calculus. Change of variables, methods of integration. 
- Two Electives
